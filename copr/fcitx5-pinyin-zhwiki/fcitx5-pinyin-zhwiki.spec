...
Version:        0.3.0.%{dict_ver}
Release:        1%{?dist}
Summary:        Fcitx 5 Pinyin Dictionary from zh.wikipedia.org

License:        CC-BY-SA-4.0 GFDL-1.3-or-later
URL:            https://github.com/felixonmars/fcitx5-pinyin-zhwiki
Source0:        %{url}/releases/download/%{version}/web-slang-%{dict_ver}.dict
Source1:        %{url}/releases/download/%{version}/zhwiki-%{dict_ver}.dict
Source2:        %{url}/releases/download/%{version}/zhwikisource-%{dict_ver}.dict 
Source3:        %{url}/releases/download/%{version}/zhwiktionary-%{dict_ver}.dict
Source4:        https://raw.githubusercontent.com/felixonmars/fcitx5-pinyin-zhwiki/refs/tags/%{version}/LICENSE
